  ...
  <div class="box">
    ...
    <div class="baseInfo">
      <div class="box color2">
        <div class="header"><span class="text">未耗卡总额</span></div>
        <div class="content">
          <div class="cell">￥2342342.22 万元</div>
        </div>
      </div>
      <div class="box color1">
        <div class="header"><span class="text">耗卡率</span></div>
        <div class="content">
      ...
      <div class="box color4">
        <div class="header">
          <span class="text">进30天购买套餐次卡金额</span>
        </div>
        <div class="content">
          <div class="cell">￥2342342.22 万元</div>
        </div>
      ...
      <div class="box color3">
        <div class="header"><span class="text">进30天耗卡金额</span></div>
        <div class="content">
    ...
    <div class="big-box">
      <div class="header">各类套餐次卡剩余耗卡金额</div>
      <div class="content">
        <ValueCard />
      </div>
    </div>
