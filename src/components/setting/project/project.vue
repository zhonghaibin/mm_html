            ...
            <div slot="content">
              <div class="fields-remark">
                ...
                <p class="text">
                  ...
                  开启后该项目就会在公众号的预约中显示出来
                </p>
                <p class="text">
                  <span style="font-weight: bold">项目关联商品：</span>
                  关联之后,项目所消耗的产品会从库存扣除
                </p>
                <p class="text">
                  <span style="font-weight: bold">项口体验价：</span>
                  在客户第一次体验该项目的时候可以享受的特殊优惠价格。
                </p>
                <p class="text">
                  <span style="font-weight: bold">项目状态：</span>
                  <br />
                  上架：可以在系统中售卖该项目
                  <br />
                  下架：不可在系统中售卖该项日
                ...
                <p class="text">
                  <span style="font-weight: bold">项目配图：</span>
                  针对线上商城首图
                </p>
                <p class="text">
                  <span style="font-weight: bold">项目详情：</span>
                  针对该项目的详情介绍,可文字、图片,主要在商城展示
                </p>
              </div>
            </div>
          </Poptip>
...
<script>
  ...
  export default {
    name: 'Project',
    components: { UploadImage, SelectShop, SelectProductType, SelectPosition },
    data: function () {
      return {
        defaultList: [],
        editor: null,
