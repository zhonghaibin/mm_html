<template>
  <div class="PackageList">
    <div class="search">
      ...
      <div class="right">
        <div class="add-bt" @click="showModal('新增套餐次卡', 'Package')">
          新增项目
        </div>
        <div class="add-bt">导入套餐次卡</div>
        <div class="add-bt" @click="exportDataEvent">导出套餐次卡</div>
      </div>
    </div>
    <div class="list">
      <vxe-table
    ...
    <Modal
      ...
      :width="modal.width"
    >
      <Package v-if="modalShow('Package')" />
    </Modal>
  </div>
</template>

<script>
  import Package from '@/components/setting/project/package'
  import SelectProductType from '@/components/form/select-product-type'
  import SelectShop from '@/components/form/select-shop'
  import SelectPackageStatus from '@/components/form/select-package-status'

  export default {
    name: 'PackageList',
    components: { SelectPackageStatus, SelectShop, SelectProductType, Package },
