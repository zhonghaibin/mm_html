  ...
  <div class="CouponList">
    <div class="search">
      <div class="left">
        ...
        <div class="box">
          <span class="text">券类型</span>
          <SelectGoodsStatus v-model="searchData.status" @on-select="search" />
        </div>
      </div>
      <div class="right">
        <div class="add-bt" @click="showModal('新增券', 'Coupon')">新增券</div>
      </div>
    </div>
    <div class="list">
      <vxe-table
    ...
    <Modal
      ...
      :width="modal.width"
    >
      <Coupon v-if="modalShow('Coupon')" />
    </Modal>
  </div>
</template>

<script>
  import Coupon from '@/components/setting/project/coupon'
