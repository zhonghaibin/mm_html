    ...
    <div class="search">
      <div class="left">
        ...
        <div class="box">
          ...
          <SelectStockOutType v-model="searchData.sstid" @on-select="search" />
        </div>
        <div class="box">
          <span class="text">领用人</span>
          <SelectStaff v-model="searchData.ltid" @on-select="search" />
        </div>
        <div class="box">
          <span class="text">经办人</span>
          <SelectStaff v-model="searchData.jtid" @on-select="search" />
        </div>
      </div>
      <div class="right">
        <div class="add-bt" @click="showModal('选择出库商品', 'GoodsList')">
          选择出库商品
        </div>
      </div>
    </div>
      ...
      <table>
        <thead>
          <tr>
            ...
            <td class="color" style="width: 120px">出库数量</td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td></td>
            <td colspan="3">
              <div class="add-bt" style="float: right; width: 100px">提交</div>
            </td>
          </tr>
        </tbody>
      </table>
...
<script>
  ...
  export default {
    name: 'OutStock',
    components: { SelectStaff, SelectStockOutType, SelectShop, GoodsList },
