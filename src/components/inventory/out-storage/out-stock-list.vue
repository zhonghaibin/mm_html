  ...
  <div class="box">
    <div class="search">
      ...
      <div class="right">
        ...
        <div class="add-bt" @click="showModal('新建出库单', 'OutStock')">
          新建出库单
        </div>
      </div>
    </div>
    ...
    <Modal
      ...
      :width="modal.width"
    >
      <OutStock v-if="modalShow('OutStock')" />
    </Modal>
  </div>
</template>

<script>
  import OutStock from '@/components/inventory/out-storage/out-stock'
  import SelectShop from '@/components/form/select-shop'
  import SelectStockOutType from '@/components/form/select-stock-out-type'

  export default {
    name: 'OutStockList',
    components: { SelectStockOutType, SelectShop, OutStock },
