    ...
    <div class="search">
      <div class="left">
        ...
        <div class="box">
          ...
          <SelectStockInType v-model="searchData.ssid" @on-select="search" />
        </div>
        <div class="box">
          <span class="text">供应商</span>
          <SelectSupplier v-model="searchData.ssid" @on-select="search" />
        </div>
        <div class="box">
          <span class="text">经办人</span>
          <SelectStaff v-model="searchData.staff_id" />
        </div>
      </div>
      <div class="right">
...
<script>
  ...
  import SelectSupplier from '@/components/form/select-supplier'
