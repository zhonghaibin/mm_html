<template>
  <div class="ScheduleSet">
    <div class="search">
      ...
      <div class="right">
        <div class="add-bt" @click="showModal('添加班次', 'Schedule')">
          添加班次
        </div>
      </div>
    </div>
    ...
    <Modal
      ...
      :width="modal.width"
    >
      <Schedule v-if="modalShow('Schedule')" />
    </Modal>
  </div>
</template>

<script>
  import Schedule from '@/components/appointment/staff-schedule/schedule'
  import SelectShop from '@/components/form/select-shop'

  export default {
    name: 'ScheduleSet',
    components: { SelectShop, Schedule },
